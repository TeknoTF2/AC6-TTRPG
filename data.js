...
const AC6_DATA = {
    ...
    arms: [
        { id: 'AC-2000TOOLARM', name: 'AC-2000 TOOL ARM', hp: 600, ac: 1, fireSpec: 2, meleeSpec: 1, recoilCtrl: 0, weight: 3200, enLoad: 90, special: 'Lightweight Starter, RaD' },
        { id: 'AR-011MELANDER', name: 'AR-011 MELANDER', hp: 750, ac: 2, fireSpec: 2, meleeSpec: 2, recoilCtrl: 1, weight: 4100, enLoad: 120, special: 'Midweight Balanced, Balam' },
        { id: 'AR-012MELANDERC3', name: 'AR-012 MELANDER C3', hp: 800, ac: 2, fireSpec: 3, meleeSpec: 2, recoilCtrl: 1, weight: 4300, enLoad: 130, special: 'Midweight Melander+, Balam' },
        { id: 'DF-AR-08TIAN-QIANG', name: 'DF-AR-08 TIAN-QIANG', hp: 1100, ac: 3, fireSpec: 2, meleeSpec: 3, recoilCtrl: 3, weight: 5900, enLoad: 180, special: 'Heavyweight Powerhouse, Dafeng' },
        { id: 'DF-AR-09TIAN-LAO', name: 'DF-AR-09 TIAN-LAO', hp: 1200, ac: 3, fireSpec: 2, meleeSpec: 4, recoilCtrl: 3, weight: 6200, enLoad: 190, special: 'Heavyweight Melee Monster, Dafeng' },
        { id: 'NACHTREIHER/46E', name: 'NACHTREIHER/46E', hp: 650, ac: 1, fireSpec: 3, meleeSpec: 1, recoilCtrl: 0, weight: 3600, enLoad: 100, special: 'Lightweight Speed, Schneider' },
        { id: 'VP-46S', name: 'VP-46S', hp: 720, ac: 2, fireSpec: 4, meleeSpec: 0, recoilCtrl: 1, weight: 3900, enLoad: 110, special: 'Midweight Sniper, Arquebus' },
        { id: 'VP-46D', name: 'VP-46D', hp: 850, ac: 2, fireSpec: 3, meleeSpec: 1, recoilCtrl: 2, weight: 4500, enLoad: 140, special: 'Midweight Versatile, Arquebus' },
        { id: 'VE-46A', name: 'VE-46A', hp: 1050, ac: 3, fireSpec: 3, meleeSpec: 2, recoilCtrl: 2, weight: 5400, enLoad: 170, special: 'Heavyweight Precision, Arquebus' },
        { id: '04-101MINDALPHA', name: '04-101 MIND ALPHA', hp: 900, ac: 2, fireSpec: 3, meleeSpec: 2, recoilCtrl: 2, weight: 4800, enLoad: 150, special: 'Midweight AI Balanced, ALLMIND' },
        { id: 'EL-TA-10FIRMEZA', name: 'EL-TA-10 FIRMEZA', hp: 1000, ac: 3, fireSpec: 2, meleeSpec: 2, recoilCtrl: 3, weight: 5600, enLoad: 180, special: 'Heavyweight Tank Support, Elcano' },
        { id: 'AA-J-123BASHO', name: 'AA-J-123 BASHO', hp: 820, ac: 2, fireSpec: 2, meleeSpec: 3, recoilCtrl: 1, weight: 4400, enLoad: 135, special: 'Midweight Versatile, BAWS' },
        { id: 'AA-J-123/RCJAILBREAK', name: 'AA-J-123/RC JAILBREAK', hp: 950, ac: 2, fireSpec: 3, meleeSpec: 3, recoilCtrl: 2, weight: 5100, enLoad: 160, special: 'Heavyweight BASHO+, BAWS' },
        { id: 'AC-3000WRECKER', name: 'AC-3000 WRECKER', hp: 880, ac: 2, fireSpec: 2, meleeSpec: 2, recoilCtrl: 2, weight: 4600, enLoad: 145, special: 'Midweight Efficient, RaD, Hidden' },
        { id: 'EL-PA-00ALBA', name: 'EL-PA-00 ALBA', hp: 700, ac: 1, fireSpec: 3, meleeSpec: 1, recoilCtrl: 1, weight: 3700, enLoad: 105, special: 'Lightweight Aerial, Elcano' },
        { id: 'AS-5000SALAD', name: 'AS-5000 SALAD', hp: 920, ac: 2, fireSpec: 2, meleeSpec: 3, recoilCtrl: 2, weight: 4900, enLoad: 155, special: 'Midweight NG+, RaD' },
        { id: 'IA-C01A:EPHEMERA', name: 'IA-C01A: EPHEMERA', hp: 780, ac: 2, fireSpec: 3, meleeSpec: 2, recoilCtrl: 1, weight: 4200, enLoad: 125, special: 'Midweight Coral, Hidden' },
        { id: 'IB-C03A:HAL826', name: 'IB-C03A: HAL 826', hp: 950, ac: 3, fireSpec: 4, meleeSpec: 3, recoilCtrl: 2, weight: 5200, enLoad: 165, special: 'Heavyweight Coral Elite, NG++' }
    ],
